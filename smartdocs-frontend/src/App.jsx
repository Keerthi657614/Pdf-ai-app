...
//   // Shared state to trigger elaboration of tabs
...
//         <div className="w-full max-w-md bg-white dark:bg-[#111827] border border-slate-200 dark:border-slate-800 rounded-3xl p-8 shadow-2xl">
//           {authMode === "login" ? (
//             <>
//               <Login onLoginSuccess={handleAuthSuccess} />
//               <button className="w-full text-center text-sm text-slate-500 mt-6 hover:text-blue-500" onClick={() => setAuthMode("register")}>New user? Register</button>
//             </>
//           ) : (
//             <>
//               <Register onRegisterSuccess={handleAuthSuccess} />
//               <button className="w-full text-center text-sm text-slate-500 mt-6 hover:text-blue-500" onClick={() => setAuthMode("login")}>Back to Login</button>
//             </>
//           )}
//         </div>
//       </div>
...
//   return (
//     <div className="flex h-screen overflow-hidden bg-slate-50 dark:bg-[#030712] text-slate-900 dark:text-slate-200">
//       {/* Sidebar controls the isSidebarOpen state */}
//       <Sidebar 
...
//           <div className={`flex flex-col transition-all duration-500 ${showPdf ? "w-[60%]" : "w-full"}`}>
            
//             {/* ELABORATED TABS SECTION */}
//             <div className="px-8 py-4 bg-white/50 dark:bg-[#0a0f18]/50 border-b border-slate-200 dark:border-slate-800/50 flex items-center">
...
//                       ${!isSidebarOpen ? "flex-1 py-4 text-[11px]" : "px-5 py-2 text-[10px]"}`}
//                   >
...
//               {/* Session controls shift to far right when tabs expand */}
//               {isSidebarOpen && !showPdf && (
...
//               {activeTab === "history" && <History onLoad={(m) => { setMessages(m); setActiveTab("chat"); }} />}
//               {activeTab === "analytics" && <Analytics />}
//               {activeTab === "profile" && <Profile user={user} onUpdate={handleAuthSuccess} />}
//             </div>
//           </div>

//           {showPdf && (
//             <div className="w-[40%] border-l border-slate-200 dark:border-slate-800 bg-white dark:bg-[#0a0f18] p-6 flex flex-col transition-all duration-500">
//               <button onClick={() => setShowPdf(false)} className="self-end mb-4 text-red-500 text-[10px] font-bold uppercase hover:bg-red-500/10 px-3 py-1 rounded-lg">Close Inspector</button>
//               <div className="flex-1 rounded-2xl overflow-hidden border border-slate-200 dark:border-slate-800 shadow-2xl">
...
//             <div className="px-8 py-4 bg-white/50 dark:bg-[#0a0f18]/50 border-b border-slate-200 dark:border-slate-800/50 flex items-center">
//               <div
//                 className={`flex bg-slate-100 dark:bg-[#111827] p-1 rounded-xl transition-all duration-500 ${
//                   !isSidebarOpen ? "w-full mx-4 shadow-xl border border-blue-500/20" : "w-auto"
//                 }`}
//               >
//                 {tabs.map((t) => (
...
//                     <span className={!isSidebarOpen ? "inline" : "hidden lg:inline"}>
//                       {t.label}
//                     </span>
//                   </button>
//                 ))}
...
//           {/* PDF Inspector */}
//           {showPdf && (
//             <div className="w-[40%] border-l border-slate-200 dark:border-slate-800 bg-white dark:bg-[#0a0f18] p-6 flex flex-col">
//               <button
//                 onClick={() => setShowPdf(false)}
//                 className="self-end mb-4 text-red-500 text-[10px] font-bold uppercase hover:bg-red-500/10 px-3 py-1 rounded-lg"
//               >
//                 Close Inspector
//               </button>
//               <div className="flex-1 rounded-2xl overflow-hidden border border-slate-200 dark:border-slate-800 shadow-2xl">
