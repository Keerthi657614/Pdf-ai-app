...
// //         <div className="w-8 h-8 rounded-full bg-gradient-to-tr from-blue-600 to-cyan-400 flex items-center justify-center text-xs font-bold text-white uppercase">
// //           {user ? user.substring(0, 2) : "AI"}
// //         </div>
// //         <span className="text-sm font-medium text-slate-300">Welcome, {user}</span>
// //       </div>
      
// //       <button 
// //         onClick={onLogout}
// //         className="px-4 py-2 text-sm text-slate-400 hover:text-white hover:bg-white/5 rounded-xl transition flex items-center gap-2"
// //       >
...
//           className="w-9 h-9 rounded-full bg-gradient-to-tr from-blue-600 to-cyan-400
//                      flex items-center justify-center text-xs font-bold text-white uppercase
