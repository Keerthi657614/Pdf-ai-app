...
//                 <div className="absolute -top-2 -right-2 w-5 h-5 bg-cyan-400 rounded-full border-4 border-slate-50 dark:border-[#030712] animate-bounce shadow-lg" />
//               </div>
//             </div>
...
//                            dark:bg-[#111827] dark:border-slate-800 dark:hover:border-slate-700"
//                 >
//                   <div className="w-10 h-10 rounded-xl bg-blue-50 dark:bg-blue-600/10 flex items-center justify-center text-blue-500 dark:text-blue-400 group-hover:scale-110 transition">
...
//                       }))}
//                       className="flex items-center gap-2 text-[10px] font-bold uppercase bg-slate-50 dark:bg-slate-800/50 hover:bg-slate-100 dark:hover:bg-slate-800 px-3 py-1.5 rounded-lg text-blue-600 dark:text-blue-400 border border-slate-200 dark:border-slate-700 transition-all"
//                     >
...
//         <input
//           className="w-full py-4 pl-6 pr-16 text-sm rounded-2xl border transition-all shadow-sm
//                    bg-white border-slate-200 text-slate-800 focus:border-blue-500 focus:outline-none
//                    dark:bg-[#111827] dark:border-slate-800 dark:text-slate-200 dark:focus:border-blue-500"
