...
// // import { listSessions, loadSession, deleteSession, renameSession } from "../api/session";
...
// //   // Auto-scroll when a conversation is opened
// //   useEffect(() => {
// //     if (activeSession) {
...
// //       // Backend should return sessions as an array
...
// //       {/* --- RIGHT PANEL: Gemini Style Elaborated View --- */}
...
// //               {activeSession.history && activeSession.history.map((chat, idx) => (
// //                 <div key={idx} className="space-y-6 animate-in fade-in slide-in-from-bottom-2 duration-700">
                  
// //                   {/* User Question Bubble */}
// //                   <div className="flex gap-4 items-start">
// //                     <div className="w-10 h-10 rounded-2xl bg-slate-100 dark:bg-slate-800 flex-shrink-0 flex items-center justify-center border border-slate-200 dark:border-slate-700">
// //                       <i className="fas fa-user text-slate-500" />
// //                     </div>
// //                     <div className="flex-1">
// //                        <p className="text-[11px] font-black uppercase text-slate-400 mb-1">User Query</p>
// //                        <p className="text-base font-medium text-slate-800 dark:text-slate-100 bg-slate-50 dark:bg-slate-900/50 p-4 rounded-2xl border border-slate-100 dark:border-slate-800">
// //                          {chat.question}
// //                        </p>
// //                     </div>
// //                   </div>

// //                   {/* AI Elaborated Answer */}
// //                   <div className="flex gap-4 items-start w-full">
// //                     <div className="w-10 h-10 rounded-2xl bg-gradient-to-br from-blue-600 to-indigo-700 flex-shrink-0 flex items-center justify-center shadow-xl shadow-blue-500/20">
// //                       <i className="fas fa-robot text-white" />
// //                     </div>
// //                     <div className="flex-1 space-y-4">
// //                       <p className="text-[11px] font-black uppercase text-blue-500 mb-1">SmartDocs AI Response</p>
...
//       setIsExporting(true);
//       const res = await loadSession(user, sessionId);
//       // Pass the whole data object which contains session_id, created_at, and history
//       if (res.data?.history) {
//         exportSessionToPDF(res.data);
//       }
//     } catch (err) {
